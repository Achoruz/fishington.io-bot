...
class Fisher:
    ...
    def Sell_Fish(self):
        ...
        max_loc, max_val = self.Template_Match("../img/SellBox.jpg", self.Screen_Shot())
        print(max_val)
        print(self.sell_threshold)
        if max_val >  self.sell_threshold:
            print("We got fish to sell!")
            # self.Click_Location(max_loc[0] + 30, max_loc[1] + 30)
            self.Click_Location(max_loc[0] + 31, max_loc[1] + 30)
            # self.Click_Location(max_loc[0] + 10, max_loc[1] + 15)
            ...
            max_loc, max_val = self.Template_Match("../img/SellFor.jpg", self.Screen_Shot())
            if max_val > self.sell_threshold:
                ...
                max_loc, max_val = self.Template_Match("../img/Sell.jpg", self.Screen_Shot())
